...
export const TIER_SCORE_ADJUSTMENTS: Record<EnumTiers, { increment: number, decrement: number }> = {
    [EnumTiers.Adept]:          { increment: 8, decrement: 5 },
    [EnumTiers.Scholar]:        { increment: 8, decrement: 5 }, 
    [EnumTiers.Savant]:         { increment: 8, decrement: 5 },
    [EnumTiers.Expert]:         { increment: 8, decrement: 5 },
    [EnumTiers.Mastermind]:     { increment: 8, decrement: 5 },
    [EnumTiers.Enlightened]:    { increment: 8, decrement: 5 },
    [EnumTiers.Visionary]:      { increment: 8, decrement: 5 },
    [EnumTiers.Innovator]:      { increment: 8, decrement: 5 },
    [EnumTiers.Genius]:         { increment: 5, decrement: 5 },
    [EnumTiers.Virtuoso]:       { increment: 5, decrement: 5 },
    [EnumTiers.Luminary]:       { increment: 5, decrement: 5 },
    [EnumTiers.Illuminator]:    { increment: 5, decrement: 5 },
    [EnumTiers.Prodigy]:        { increment: 5, decrement: 5 },
    [EnumTiers.Intuitive]:      { increment: 5, decrement: 5 },
    [EnumTiers.Oracle]:         { increment: 5, decrement: 5 },
    [EnumTiers.Visionist]:      { increment: 5, decrement: 5 },
    [EnumTiers.Sage]:           { increment: 3, decrement: 5 },
    [EnumTiers.Thinker]:        { increment: 3, decrement: 5 },
    [EnumTiers.Philosopher]:    { increment: 3, decrement: 5 },
    [EnumTiers.Theorist]:       { increment: 3, decrement: 5 },
    [EnumTiers.Mystic]:         { increment: 3, decrement: 5 },
    [EnumTiers.Seer]:           { increment: 3, decrement: 5 },
    [EnumTiers.Transcendent]:   { increment: 3, decrement: 5 },
};
